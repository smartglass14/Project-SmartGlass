...
export default function CreateQuiz() {
  ...
  return (
    ...
    {
        sessionCode && popUp &&
        <SessionPopup sessionCode={sessionCode} onClose={()=> setPopUp(false)}/>
    }
...
function SessionPopup({ sessionCode, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-400/60 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-2xl shadow-lg max-w-sm w-full text-center space-y-4">
        ...
        <p className="text-gray-700 font-semibold">Share this session code with participants</p>
